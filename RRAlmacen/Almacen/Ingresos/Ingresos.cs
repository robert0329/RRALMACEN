...
namespace RRAlmacen.Almacen.Ingresos
{
    public partial class Ingresos : Form
    {
        ...
        {
            ProveedorcomboBox.DataSource = NProveedor.Mostrar();
            ProveedorcomboBox.ValueMember = "idproveedor";
            ProveedorcomboBox.DisplayMember = "razon_social";

        }
        private void LlenarComboArticulo()
        {
            ArticulocomboBox.DataSource = NArticulo.Mostrar();
        ...
        private void Habilitar(bool valor)
        {
            ...
            this.ArticulocomboBox.Enabled = valor;
            this.ProveedorcomboBox.Enabled = valor;
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            this.ProveedorcomboBox.Text = Convert.ToString(this.dataListado.CurrentRow.Cells["proveedor"].Value);
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //else
                {
                    ...
                    {
                        if (Convert.ToInt32(row["idarticulo"]) == Convert.ToInt32(this.ArticulocomboBox.SelectedValue))
                        {
                            registrar = false;
                    ...
                    if (registrar)
                    {
                        ...
                        row["idarticulo"] = Convert.ToInt32(this.ArticulocomboBox.SelectedValue);
                        row["articulo"] = this.ArticulocomboBox.Text;
